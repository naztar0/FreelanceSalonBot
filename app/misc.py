...
master_buttons_2 = ("Подписки", "Портфолио", "Салон/Мастер", "Местоположение", "⬅ Назад­")
back_button = "⬅ Назад"
next_button = "Далее ➡"
save_changes = "🆗 Закончить выбор"
renew_subscription = "Продлить подписку"
edit_buttons = ("Изменить", "Изменить всё", "Изменить текст", "Изменить медиа")
edit_buttons_salon = ("Изменить", "Изменить всё", "Изменить описание салона", "Изменить медиа")
